  ...
  useEffect(() => {
    ...
    const testApiHealth = async () => {
      try {
        ...
        setApiStatus('⚠️ API Health fetch failed: ' + error);
      }
    };
    ...
    <div className="container">
      ...
      <div className="dashboard-grid">
        ...
        <div className="dashboard-card">
          ...
          <div className="button-group">
            <div className="button-item">
              <a href="/webofinfluence/api/APITest.html" className="dashboard-button">
        ...
        <div className="dashboard-card">
          ...
          <div className="button-group">
            <div className="button-item">
              <a href="/webofinfluence/analytics/analytics.html" className="dashboard-button">
        ...
        <div className="dashboard-card">
          ...
          <div className="button-group">
            <div className="button-item">
              <a href="/webofinfluence/src/ai-name-finder.html" className="dashboard-button">
      ...
      <div className="config-section">
        ...
        <div className="config-code">{JSON.stringify(config, null, 2)}</div>
